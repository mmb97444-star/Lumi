...
for (const token of ['encodeApng', 'makeZip', 'removeBackgroundFromCanvas', 'OFFICIAL_SPECS', 'analyzeStickerIntent', 'saveTextDatabase', 'MAX_REFERENCE_IMAGES', 'applyPhotoStyle', 'estimatePhotoScore', 'getPoseTransform', 'drawReferencePoseOverlay', 'drawMascotBody']) {
